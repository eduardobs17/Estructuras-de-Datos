...
/**
 * Clase para la prueba de DoubleLinkedList.
 * @author Eduardo Biazzetti.
 */
public class DoubleLinkedListTest {

    /**
     * Programa de prueba para DoubleLinkedList.
    ...
    public static void main(String[] args) {
        ...
        lista.add(1,3);
        System.out.println("Debe dar error: (NULL_POINTER_EXCEPTION) ");
        lista.add(1,null);
        lista.add(2,4);
        lista.add(5);
        lista.add(1,2);
        ...
        DoubleLinkedList<String> nuevo = new DoubleLinkedList<>();
        nuevo.add("Nombres");
        nuevo.add("De");
        nuevo.add("Personas");
        nuevo.add("Raquel");
