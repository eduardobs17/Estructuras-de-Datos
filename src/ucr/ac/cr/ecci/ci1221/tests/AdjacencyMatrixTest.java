...
/**
 * Clase de prueba para AdjacencyMatrix.
 * @author Eduardo Biazzetti.
 */
public class AdjacencyMatrixTest {

    /**
     * Programa de prueba para AdjacencyMatrix.
     *
     * @param args los parametros que recibe el main.
     */
    public static void main(String[] args) {
        Graph<Integer> grafo = new AdjacencyMatrix<>();
        ...
        Graph<Integer> grafoDCP = new AdjacencyMatrix<>(true, true); //Grafo dirigido con pesos
        grafoDCP.addNode(9);
        grafoDCP.addNode(1);
        grafoDCP.addNode(3);
        grafoDCP.addNode(5);
        ...
        Graph<Integer> grafoDSP = new AdjacencyMatrix<>(true, false); //Grafo dirigido sin pesos
        grafoDSP.addNode(9);
        grafoDSP.addNode(1);
        grafoDSP.addNode(3);
        grafoDSP.addNode(5);
        ...
        Graph<Integer> grafoNDSP = new AdjacencyMatrix<>(false, false); //Grafo no dirigido sin pesos
        grafoNDSP.addNode(9);
        grafoNDSP.addNode(1);
        grafoNDSP.addNode(3);
        grafoNDSP.addNode(5);
