...
public class EdgeListTest {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Se busca adyacencia 7-9, debe ser true: " + grafo.areLinked(7,9));
        ...
        Graph<Integer> grafoDCP = new EdgeList<>(true, true); //Grafo dirigido con pesos
        grafoDCP.addNode(9);
        grafoDCP.addNode(1);
        grafoDCP.addNode(3);
        grafoDCP.addNode(5);
        ...
        Graph<Integer> grafoDSP = new EdgeList<>(true, false); //Grafo dirigido sin pesos
        grafoDSP.addNode(9);
        grafoDSP.addNode(1);
        grafoDSP.addNode(3);
        grafoDSP.addNode(5);
        ...
        Graph<Integer> grafoNDSP = new EdgeList<>(false, false); //Grafo no dirigido sin pesos
        grafoNDSP.addNode(9);
        grafoNDSP.addNode(1);
        grafoNDSP.addNode(3);
        grafoNDSP.addNode(5);
