...
/**
 * Clase para la prueba de InvertedArrayStack.
 * @author Eduardo Biazzetti.
 */
public class InvertedArrayStackTest {

    /**
     * Programa de prueba para InvertedArrayStack.
     * @param args parametros que recibe el main (si los hubieran).
     */
    public static void main(String[] args) {
        Stack<Integer> array = new InvertedArrayStack<>();
